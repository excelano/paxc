...
//! instruction — `paxc --install-skill` — true everywhere.
//!
...
const FILES: &[(&str, &str)] = &[
    ...
    (
        "connectors.md",
        include_str!("../skills/paxc/connectors.md"),
    ),
];
...
mod tests {
    ...
    fn the_stamp_sits_under_the_frontmatter_not_inside_it() {
        ...
        assert!(out[fm_end..].contains("This skill documents paxc 9.9.9"));
        // The body survives intact underneath.
        assert!(out.ends_with("# paxc\n"));
    }
